"""
Simple Real-time Deepfake Demo

This demo creates videos of people doing mundane tasks in real-time
without requiring mediapipe (which has compatibility issues with Python 3.13).
"""
...
class SimpleMundaneTaskGenerator:
    """Simple generator for mundane task animations."""
...
class SimpleFaceSwapper:
    """Simple face swapping using OpenCV."""
...
class SimpleRealtimeGenerator:
    """Simple real-time generator for mundane tasks."""
    ...
    def start_generation(self, source_face_path: str, task_name: str = 'typing',
        ...
        self.task_generator = SimpleMundaneTaskGenerator(task_name)
...
def main():
    """Main demo function."""
    print("🎬 Simple Real-time Deepfake Demo")
    print("=" * 40)
    ...
    generator = SimpleRealtimeGenerator(target_fps=30)
    ...
    result = generator.start_generation(
        ...
        task_name='typing',
        virtual_camera=True,
        output_path="output/simple_realtime_demo.mp4"
    )
    ...
    print("\n📹 Your virtual webcam is now active!")
    print("   You can use it in Zoom, Discord, Teams, etc.")
    ...
    print("\n🎉 Demo completed!")
    print("📹 Your virtual webcam should now be available in video applications!")
